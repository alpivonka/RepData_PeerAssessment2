...
INJURIES<-rawData %>% group_by(EVENTTYPE) %>% summarise_each(funs(sum),vars=c(-BGN_DATE,-FATALITIES,-MAG,-WFO,-PROPDMGEXP,-PROPDMG,-CROPDMG,-CROPDMGEXP))
INJURIES$TT<-INJURIES$FATALITIES + INJURIES$INJURIES
arrange(INJURIES,desc(TT))
